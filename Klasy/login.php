...
/*
    function __construct(){ ?>
        ...
        <form action="index.php" method="post">
            ...
            <button name="submit" value="dodaj">Login</button>
            <a href="klasy/RegistrationForm.php">Register</a>
    ...
    //    if(!get_magic_quotes_gpc()) $text_to_escape=mysqli::real_escape_string ( $text_to_escape );
    ...
    public function setLoginSession()
    {
        ...
        {
            $user_id=$this->setEscape($_POST['user_id']);
            $password=$this->setCrypt($_POST['password']);
            $result=mysqli_query("SELECT * FROM users WHERE user_id='$user_id' AND password='$password'");
          //  $result=$bd->select("select login, passwordhash from"." ".$this->databaseUsersTable." "."WHERE user_id='$user_name' AND password='$user_pass'", array("login","passwordhash"));
